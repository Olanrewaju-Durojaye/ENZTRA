# Publishing ENZTRA v1.0.0 on GitHub
...
git init
git add .
git commit -m "Release ENZTRA v1.0.0"
git branch -M main
git remote add origin <YOUR_GITHUB_REPOSITORY_URL>
git push -u origin main
git tag -a v1.0.0 -m "ENZTRA v1.0.0"
